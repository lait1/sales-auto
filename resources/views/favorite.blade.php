        ...
        @forelse($auto as $item)
            <div class="catalog-item">
                <div class="catalog-item__image">
                    <a href="/auto/{{$item->slug}}"><img src="/upload/thumbnail/{{$item->getFirstImage()}}" alt=""></a>
                </div>
                ...
                <div class="catalog-item__action">
                    <a href="/favorite/{{$item->id}}/delete" class="catalog-item__action-delete">Удалить <i class="fa fa-trash-o" aria-hidden="true"></i></a>
                    <div class="catalog-item__action-price">Стоимость</div>
                    <div class="catalog-item__action-cost">{{$item->getPrice()}} <i class="fa fa-rub"
